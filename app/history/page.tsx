...
const PANELS = [
  ...
  },
  {
    ...
    parameters: [
      { key: 'S. Sodium', label: 'Sodium (mmol/L)', color: '#2563eb' },
      { key: 'S. Potassium', label: 'Potassium (mmol/L)', color: '#0d9488' },
      { key: 'S. Chloride', label: 'Chloride (mmol/L)', color: '#d97706' },
      { key: 'S. Calcium', label: 'Calcium (mg/dL)', color: '#ea580c' },
      { key: 'S. Magnesium', label: 'Magnesium (mg/dL)', color: '#8b5cf6' },
    ],
  },
  {
    id: 'renal-hepatic',
    ...
    parameters: [
      { key: 'S. Creatinine', label: 'S. Creatinine (mg/dL)', color: '#f43f5e' },
      { key: 'S. Urea', label: 'Urea (mg/dL)', color: '#d97706' },
      { key: 'S. Uric Acid', label: 'Uric Acid (mg/dL)', color: '#2563eb' },
